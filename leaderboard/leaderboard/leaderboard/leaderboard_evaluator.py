...
class LeaderboardEvaluator(object):
    ...
    def __init__(self, args, statistics_manager):
        ...
        self.client.set_timeout(float(self.client_timeout))

        #self.traffic_manager = self.client.get_trafficmanager(args.traffic_manager_port)
        #test
        self.traffic_manager = self.client.get_trafficmanager(2050)
    ...
    def run(self, args):
        ...
        #test
        route_indexer = RouteIndexer(args.routes, args.scenarios, args.repetitions, 0)
...
def main():
    ...
    parser.add_argument('--routes',
                        ...
                        required=True)
    parser.add_argument('--route_id', default='', type=str,
    ...
    # adding for test
    parser.add_argument("--traffic_manager_port", type=int, default=2050)
